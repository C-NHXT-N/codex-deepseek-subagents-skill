...
export ANTHROPIC_MODEL='__MODEL_SH__'
export ANTHROPIC_DEFAULT_OPUS_MODEL='__MODEL_SH__'
export ANTHROPIC_DEFAULT_SONNET_MODEL='__MODEL_SH__'
export ANTHROPIC_DEFAULT_HAIKU_MODEL='__FAST_MODEL_SH__'
export CLAUDE_CODE_SUBAGENT_MODEL='__FAST_MODEL_SH__'
export CLAUDE_CODE_EFFORT_LEVEL='max'

# Local scheduler runtime used by Codex.
