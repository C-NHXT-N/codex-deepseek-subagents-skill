...
`/v1/responses` remains a smoke-test endpoint. It does not implement `stream=true`, `tools`, or `tool_choice`.
...
- `doctor` should report config presence, registry summary, direct API health, and runtime health separately.
